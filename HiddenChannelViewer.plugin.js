 ...
 module.exports = (_ => {
	const config = {
		"info": {
			...
			"author": "Seer :D",
			"version": "3.2.5",
			"description": "Displays all hidden Channels, which can't be accessed due to Role Restrictions, this won't allow you to read them (impossible) - Modified by Seer"
		}
	};
